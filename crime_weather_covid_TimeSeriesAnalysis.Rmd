...
Above, we are using the total of counts to aggregate the months. That, however, is not optimal. There is a variable number of days per months. Let's account for that and, instead, use the average daily number of offenses per month.
